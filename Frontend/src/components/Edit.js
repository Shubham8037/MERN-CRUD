...
class Edit extends Component {
  ...
  componentDidMount() {
    axios.get('REPLACE_THIS_WITH_YOUR_API/'+this.props.match.params.id)
      .then(res => {
  ...
  onSubmit = (e) => {
    ...
    axios.put('REPLACE_THIS_WITH_YOUR_API/'+this.props.match.params.id, { first_name, second_name, gender, description, age, job })
      .then((result) => {
          ...
          <div class="panel-body">
            ...
            <form onSubmit={this.onSubmit}>
              ...
              <div class="form-group">
                ...
                <select className="form-control" name="gender" value={this.state.person.gender} onChange={this.onChange}>
