...
class Create extends Component {
  ...
  onSubmit = (e) => {
    ...
    axios.post('REPLACE_THIS_WITH_YOUR_API', { first_name, second_name, gender, description, age, job })
      .then((result) => {
          ...
          <div class="panel-body">
            ...
            <form onSubmit={this.onSubmit}>
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="gender" value={gender} onChange={this.onChange}>
